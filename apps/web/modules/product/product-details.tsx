...
const ProductDetailsPage: React.FC = () => {
  ...
  const productDetails = products.data && products.data[0];
  ...
  const deleteProduct = useDeleteProduct({ onSuccess, onError });
  ...
  return (
    <div>
        ...
        <div className="flex gap-[21px]">
                ...
                <div className="flex gap-[4rem] flex-wrap">
                  ...
                  <div className="mb-4">
                    ...
                    <p className="text-white text-[2.4rem] leading-[2.4rem] font-medium">
                      {productDetails && productDetails.discount
                        ? new Intl.NumberFormat("en", {
                            currency: "NGN",
                          }).format(Number(productDetails?.discount))
                        : "N/A"}
                    </p>
                    {productDetails && productDetails.discount && (
                  ...
                  <div className="mb-4">
                    ...
                    <p className="text-white text-[1.2rem] leading-[2.4rem] font-medium">
                      {productDetails?.subscription_type ?? "N/A"}
                    </p>
                  </div>
          ...
          <div className="w-[33%]">
            {products.isLoading ? (
              ...
              <>
                {productDetails && productDetails.images.length ? (
                  <>
      ...
      {productDetails && openConfirmModal && (
        <Loader
          ...
          Message={() => (
            <ConfirmModal
              ...
              okHandler={() => {
                deleteProduct.mutate(productDetails?.id as string);
              }}
              okText="Confirm"
