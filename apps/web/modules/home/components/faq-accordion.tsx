  ...
  return (
    <Accordion type="single" collapsible className="w-full">
      {FAQ_CONTENT.map((accordion) => (
        <AccordionItem
          value={accordion.key}
          className="w-[91rem] bg-[#232323] mb-[4.2rem] rounded-[2rem] border border-[rgba(255,255,255,0.38)] py-[48.45px] px-[82.09px] "
        >
          <AccordionTrigger> {accordion.title}</AccordionTrigger>
          <AccordionContent className=" w-[716.03px] text-[2rem] leading-[3.4rem] text-[rgba(255,255,255,0.63)]">
            {accordion.content}
          </AccordionContent>
        </AccordionItem>
      ))}
